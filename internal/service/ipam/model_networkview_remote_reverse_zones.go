...
// NetworkviewRemoteReverseZonesModel is the Terraform model for NetworkviewRemoteReverseZones
...
// NetworkviewRemoteReverseZonesAttrTypes contains the attribute types for NetworkviewRemoteReverseZonesModel
...
// NetworkviewRemoteReverseZonesResourceSchemaAttributes contains the schema attributes for NetworkviewRemoteReverseZonesModel
...
// ExpandNetworkviewRemoteReverseZones converts a Terraform Object to SDK type
func ExpandNetworkviewRemoteReverseZones(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosipam.NetworkviewRemoteReverseZones {
...
func (m *NetworkviewRemoteReverseZonesModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosipam.NetworkviewRemoteReverseZones {
	if m == nil {
		return nil
	}
	to := &niosipam.NetworkviewRemoteReverseZones{
...
// FlattenNetworkviewRemoteReverseZones converts an SDK type to Terraform Object
func FlattenNetworkviewRemoteReverseZones(ctx context.Context, from *niosipam.NetworkviewRemoteReverseZones, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *NetworkviewRemoteReverseZonesModel) Flatten(ctx context.Context, from *niosipam.NetworkviewRemoteReverseZones, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
